...
class TrainMNIST(TrainingBase):
    ...
    def train_model_local(self, model: nn.Module, loader: DataLoader, training_parameters: Dict[str, Any]) -> List[float]:
        ...
        if training_parameters['checkpoint']:
            checkpoint_uri = f's3://{training_parameters["checkpoint_bucket"]}/{training_parameters["project_name"]} \
                                /{training_parameters["experiment_name"]}/{training_parameters["run_id"]} \
    ...
    def setup_local_training(self, training_parameters: Dict[str, Any], loader_type: str):
        ...
        compute_time_by_epoch = self.train_model_local(model, train_loader, training_parameters)
    ...
    def setup_local_testing(self, training_parameters: Dict[str, Any], loader_type: str):
        ...
        self.test_model_local(model, test_loader, training_parameters)
...
def main():
    ...
    if args.train:
        ...
        training_parameters = {
            ...
            'epochs': 10,
            'experiment_name': 'four-hidden-layer-test',
            'hidden_sizes': [1024, 1024, 1024, 1024],
            'input_size': 784,
            'lr': 0.025,
            'model_name': 'mnist-four-layers.pth',
            'momentum': 0.5,
            'num_workers': 2,
            'output_size': 10,
            'project_name': 'mnist',
        ...
        tm = TrainMNIST()
        tm.setup_local_training(training_parameters, args.loader_type)
    ...
    if args.test:
        ...
        tm = TrainMNIST()
        tm.setup_local_testing(training_parameters, args.loader_type)
