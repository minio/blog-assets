...
def put_text(bucket_name: str, object_name: str, text: str) -> ObjectWriteResult:
    '''
    This function will upload a file to MinIO and return the object_info.
    '''
    ...
    object_write_result = client.put_object(bucket_name, object_name, io.BytesIO(text_as_bytes), len(text_as_bytes))
    return object_write_result
