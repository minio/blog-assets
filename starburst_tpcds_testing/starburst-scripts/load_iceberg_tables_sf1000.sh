#!/bin/bash
# load_iceberg_tables_sf1000.sh
# Loads all TPC-DS sf1000 tables into aistor.scale1000 via Starburst REST API.
...
SCHEMA="scale1000"
SOURCE="tpcds.sf1000"
LOG="/tmp/load_iceberg_tables_sf1000.log"

# All 25 TPC-DS tables ordered small → large
# Note: date_dim and catalog_page were missing from sf10000 script — included here
TABLES=(
...
echo "=== TPC-DS sf1000 → aistor.scale1000 ===" | tee -a "$LOG"
