#!/bin/bash
# load_iceberg_tables_sf3000.sh
# Loads all TPC-DS sf3000 tables into aistor.scale3000 via Starburst REST API.
...
SCHEMA="scale3000"
SOURCE="tpcds.sf3000"
LOG="/tmp/load_iceberg_tables_sf3000.log"

# All 25 TPC-DS tables ordered small → large
# Note: date_dim and catalog_page were missing from sf30000 script — included here
TABLES=(
...
echo "=== TPC-DS sf3000 → aistor.scale3000 ===" | tee -a "$LOG"
